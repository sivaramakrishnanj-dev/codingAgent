...
| US | Tasks |
|----|-------|
| US-1/2/3 greenfield | T-3.1, T-3.2, T-3.3, T-3.4, T-3.5 (US-2 traceability-vocabulary alignment, AC-2.5/AC-2.2), T-3.6 (US-2 write_artifact AC-1.4 containment, DCR-6), T-3.7 (US-2 gate real-breakdown miscounting hardening + prompt, AC-2.2/AC-2.5, DCR-6) |
